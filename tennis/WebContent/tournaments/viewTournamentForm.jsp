...
%>
    <TR >
      <TD><INPUT type="text" name=<%=matchNumber%>/><%=matchNumber%></TD>
      <TD><INPUT type="text" name="group"+<%=matchNumber%>/><%= match.getFormat().getGroup() %></TD>
      <TD><INPUT type="text" name="players"+<%=matchNumber%>>/><%= match.toString()%></TD>
...
<% } %>
 ...
 <br />
<FORM action="addTournamentScore.jsp" method="POST">
