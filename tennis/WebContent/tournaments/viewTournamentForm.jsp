...
for (Match match: matches) { 
  ...
  if(match.isPlayed()){
    ...
    <%} %>
      ...
      <TD><INPUT type="text" name="sc1_<%=matchNumber%>" value="<%=match.getPoints1()%>" autocomplete="off"/> </TD>
      <TD><INPUT type="text" name="sc2_<%=matchNumber%>" value="<%=match.getPoints2()%>" autocomplete="off" /> </TD>
    </TR>
<% } %>
